...
def generate_launch_description():
    ...
    urdf_path = os.path.join(get_package_share_path('scara_description'),
                             'urdf', 'scara_trajectory_controller.xacro')
    #Ruta del archvo RVIZ
    
    package_path = os.path.join( get_package_share_directory('scara_description') )
    ...
    world = os.path.join(
        get_package_share_directory('scara_bringup'),
        'world',
        'test_w_1.world'
    )
